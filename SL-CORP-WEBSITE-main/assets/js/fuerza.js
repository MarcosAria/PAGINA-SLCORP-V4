...
function init() {
  ...
  // Initialize all slides with tilt effect
...
function updateSlideStates(currentIndex) {
  const slides = [...document.querySelectorAll(".slide")];
  const slidesInfo = [...document.querySelectorAll(".slide-info")];
  ...
  // Set current, previous and next attributes
...
function changeSlide(direction) {
  ...
  currentSlideIndex = wrap(currentSlideIndex + direction, totalSlides);
  updateSlideStates(currentSlideIndex);
}
